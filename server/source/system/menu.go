...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "8", Path: "autoCode", Name: "autoCode", Component: "view/systemTools/autoCode/index.vue", Sort: 1, Meta: Meta{Title: "代码生成器", Icon: "cpu", KeepAlive: true}},
		{MenuLevel: 0, Hidden: false, ParentId: "8", Path: "formCreate", Name: "formCreate", Component: "view/systemTools/formCreate/index.vue", Sort: 2, Meta: Meta{Title: "表单生成器", Icon: "magic-stick", KeepAlive: true}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "8", Path: "autoCodeAdmin", Name: "autoCodeAdmin", Component: "view/systemTools/autoCodeAdmin/index.vue", Sort: 1, Meta: Meta{Title: "自动化代码管理", Icon: "magic-stick"}},
		{MenuLevel: 0, Hidden: true, ParentId: "8", Path: "autoCodeEdit/:id", Name: "autoCodeEdit", Component: "view/systemTools/autoCode/index.vue", Sort: 0, Meta: Meta{Title: "自动化代码（复用）", Icon: "magic-stick"}},
		...
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "prom", Name: "prom", Component: "view/monitor/prom.vue", Sort: 4, Meta: Meta{Title: "数据源", Icon: "menu"}},
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "method", Name: "method", Component: "view/monitor/method.vue", Sort: 5, Meta: Meta{Title: "告警媒介", Icon: "menu"}},
		{MenuLevel: 0, Hidden: false, ParentId: "19", Path: "group", Name: "group", Component: "view/monitor/group.vue", Sort: 6, Meta: Meta{Title: "告警组", Icon: "menu"}},
	}
